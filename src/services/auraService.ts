...
export const createCustomer = async (customerData: Partial<Customer>) => {
  try {
    ...
    return handleFirestoreError(error, 'create', 'customers');
  }
};
...
export const updateCustomer = async (customerId: string, updates: Partial<Customer>) => {
  try {
    ...
    return handleFirestoreError(error, 'update', `customers/${customerId}`);
  }
};
...
export const createDriver = async (driverData: Partial<Driver>) => {
  try {
    const fullDriver = {
      ...
      onTimeRate: driverData.onTimeRate || 100,
    ...
    return handleFirestoreError(error, 'create', 'drivers');
  }
};
...
export const updateDriver = async (driverId: string, updates: Partial<Driver>) => {
  try {
    ...
    return handleFirestoreError(error, 'update', `drivers/${driverId}`);
  }
};
...
export const getReminders = async (date?: string) => {
  ...
  try {
    ...
    return handleFirestoreError(error, 'list', 'reminders');
  }
};
...
export const createReminder = async (reminderData: Partial<Reminder>) => {
  ...
  try {
    ...
    return handleFirestoreError(error, 'create', 'reminders');
  }
};
...
export const updateReminder = async (reminderId: string, updates: Partial<Reminder>) => {
  try {
    ...
    return handleFirestoreError(error, 'update', `reminders/${reminderId}`);
  }
};
...
export const recordSale = async (saleData: Partial<SaleRecord>) => {
  try {
    ...
    return handleFirestoreError(error, 'create', 'sales');
  }
};
...
export const updateInventoryStock = async (sku: string, quantityToDecrement: number) => {
  try {
    ...
    return handleFirestoreError(error, 'update', `inventory/sku:${sku}`);
  }
};
...
export const deleteReminder = async (reminderId: string) => {
  try {
    ...
    return handleFirestoreError(error, 'delete', `reminders/${reminderId}`);
  }
};
...
export const createOrder = async (orderData: Partial<Order>) => {
  ...
  try {
    ...
    return handleFirestoreError(error, 'create', 'orders');
  }
};
...
export const updateOrder = async (orderId: string, updates: Partial<Order>) => {
  try {
    ...
    return handleFirestoreError(error, 'update', `orders/${orderId}`);
  }
};
...
export const deleteOrder = async (orderId: string) => {
  try {
    ...
    return handleFirestoreError(error, 'delete', `orders/${orderId}`);
  }
};
